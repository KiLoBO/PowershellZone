<#
    Import into a script with: `. "<path_to_downloaded_Select-FuzzyString.ps1>"`
    Usage: 
        $data = Get-ChildItem | Select-Object -ExpandProperty Name
        $data | Select-FuzzyString sdlsdf | Out-String
    
    The higher the score the better the match

    Pulled needed functions from: https://github.com/gravejester/Communary.PASM and combined into a single function to
    avoid breaking org policy and installing modules.
#>
